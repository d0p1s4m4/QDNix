...
.for m in ${MAN1}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man1/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN2) && !empty(MAN2)
	mkdir -p ${DESTDIR}/html/man/man2
.for m in ${MAN2}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man2/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN3) && !empty(MAN3)
	mkdir -p ${DESTDIR}/html/man/man3
.for m in ${MAN3}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man3/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN4) && !empty(MAN4)
	mkdir -p ${DESTDIR}/html/man/man4
.for m in ${MAN4}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man4/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN5) && !empty(MAN5)
	mkdir -p ${DESTDIR}/html/man/man5
.for m in ${MAN5}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man5/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN6) && !empty(MAN6)
	mkdir -p ${DESTDIR}/html/man/man6
.for m in ${MAN6}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man6/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN7) && !empty(MAN7)
	mkdir -p ${DESTDIR}/html/man/man7
.for m in ${MAN7}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man7/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN8) && !empty(MAN8)
	mkdir -p ${DESTDIR}/html/man/man8
.for m in ${MAN8}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man8/${m:R:S/$/.html/g} ${m}
.endfor
.endif
.if defined(MAN9) && !empty(MAN9)
	mkdir -p ${DESTDIR}/html/man/man9
.for m in ${MAN9}
	${PANDOC} ${PANDOC_FLAGS} -o ${DESTDIR}/html/man/man9/${m:R:S/$/.html/g} ${m}
.endfor
.endif
